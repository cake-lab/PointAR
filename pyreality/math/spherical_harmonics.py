...
from pyreality.io.point_cloud import PointCloud
...
class SphericalHarmonics:
    ...
    @staticmethod
    def from_sphere_points(points: PointCloud, degrees=2):
        sh = SphericalHarmonics(degrees=degrees)
    ...
    def project_sphere_points(self, sphere_points: PointCloud):
